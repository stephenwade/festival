  ...
  static get properties() {
    return {
      ...
      _stateDescription: {
        type: String,
        computed:
          '_computeStateDescription(state, state.setsLoaded, state.setsData, state.audioContextReady, state.audioVisualizerData, state.targetShowStatus, state.targetCurrentSet, state.audioStatus)'
      }
    };
  }
